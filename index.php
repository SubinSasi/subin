...
<head>
  ...
  <title>Subin Sasi | Freelance Website Developer Based In Calicut, Kerala, India</title>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="HandheldFriendly" content="true">
  <meta name="author" content="subin sasi" >
  <meta name="title" content="Subin Sasi | Freelance Website Developer Based In Calicut, Kerala, India" />
  <meta name="description" content="Subin Sasi | Freelance Website Developer Based In Calicut, Kerala, India. Ecommerce Developer. Static Website Developer" />
...
<body class="home light-skin">
  ...
  <?php include 'inc/header.php';?>
    				...
    				<div class="section hero-started">
    					<div class="content scrolla-element-anim-1 scroll-animate" data-animate="active">
    						...
    						<div class="description">
    							<div>
    								<p>
                      I'm a full-stack developer based in Calicut, Kerala, India. I have developed many types 
                      of Static and Ecommerce shopping platforms. I'm passionate about cutting-edge, pixel-perfect, 
                    ...
                    <a href="https://api.whatsapp.com/send?phone=918281961011" target="blank" title="whatsapp">
                      <i class="fab fa-whatsapp"></i>
    					...
    					<div class="slide scrolla-element-anim-1 scroll-animate" data-animate="active">
    						<img decoding="async" src="assets/images/subin-full-size.png" alt="Subin Sasi" >
    						...
    						<div class="info-list">
    							<ul>
    								<li>
    									<span class="num">1.5 <strong>+</strong>
    									</span>
            ...
            <div class="pricing-items row">
              ...
              <div class="pricing-col col-xs-12 col-sm-6 col-md-6 col-lg-4">
                <div class="pricing-item scrolla-element-anim-1 scroll-animate" data-animate="active">
                  <div class="lui-subtitle">
                    <h4 class="fs-5"> Technical Skills </h4>
                  </div>
                  <div class="list pt-4">
                    <div>
                      <ul>
                        <li>
                          <i class="fab fa-react"></i>React JS, jQuery,
                        </li>
                        <li>
                          <i class="fab fa-npm"></i>npm, Yarn
                        </li>
                        <li>
                        ...
                        <li>
                          <i class="fas fa-server"></i>Netlify, Vercel
                        </li>
                        <li>
                          <i class="fas fa-search"></i>Research and Planning
                        </li>
                        <li>
                          <i class="far fa-times-circle"></i>Identifying Problem
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <div>
                      <ul>
                        <li>
                          ...
                          <b>Full Stack Developer</b> <br> Pixell Media Technologies <br>
                          May 2022 - Present . 1 year 6 months <br> Kozhikode, Kerala, India
                        </li>
                      </ul>
                    </div>
                  </div>

                  <div class="lui-subtitle pt-5">
                    <h4 class="fs-5"> Certificates </h4>
                  </div>
                  <div class="list pt-4">
                    <div>
                      <ul>
                        <li>
                          <i class="fab fa-google"></i>Google Digital Garage
                          The fundamentals of digital marketing - 2022
                        </li>
                        <li>
                          <i class="fas fa-certificate"></i>Simplilearn
                          Artificial Intelligence - 2022
                        </li>
                        <li>
                          <i class="fas fa-certificate"></i>Tata Consultancy Services
                          Youth employment program - 2021
                        </li>
                        <li>
                          <i class="fas fa-certificate"></i>FutureLearn
                          Communicating across Cultures - 2022
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <div>
                      <ul>
                        <li>
                          ...
                          <b>College of Applied Science Thiruvambady</b> <br> 
                          Bachelor of Computer Science - Computer Science <br> 2018 - 2021
                        </li>
                        <li>
                          <i class="fas fa-user-graduate"></i>
                          <b>St Joseph higher secondary school Pullurampara</b> <br> 
                          High School Diploma - Computer Science <br> 2016 - 2018
                        </li>
                        <li>
                          <i class="fas fa-user-graduate"></i>
                          <b>St Joseph high school Pullurampara</b> <br> 
                          SSLC <br> 2015 - 2016
                        </li>
                      </ul>
                    </div>
      ...
      <!-- Section - Skills -->
        ...
        <!-- Skills -->
				<div class="v-line v-line-left pt-4">
          <div class="container">
